...
bool HelloWorld::init()
{
	...
	CCSprite* pLargeCloudSprite = CCSprite::create("largecloud.png");
	pLargeCloudSprite->setAnchorPoint(ccp(0,0));
	pLargeCloudSprite->setPosition(ccp(0,visibleSize.height - pLargeCloudSprite->getContentSize().height - 50));
	CCActionInterval* actionTo = CCMoveTo::create(6,ccp(visibleSize.width,visibleSize.height - 20));
	pLargeCloudSprite->runAction(CCRepeatForever::create(actionTo));
